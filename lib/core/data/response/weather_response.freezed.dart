...
mixin _$WeatherResponse {
  WeatherLocationDTO get location => throw _privateConstructorUsedError;
...
abstract class $WeatherResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({WeatherLocationDTO location});

  $WeatherLocationDTOCopyWith<$Res> get location;
}
...
class _$WeatherResponseCopyWithImpl<$Res, $Val extends WeatherResponse>
  ...
  @pragma('vm:prefer-inline')
  $WeatherLocationDTOCopyWith<$Res> get location {
    return $WeatherLocationDTOCopyWith<$Res>(_value.location, (value) {
...
class _$WeatherResponseImpl implements _WeatherResponse {
  const _$WeatherResponseImpl({required this.location});
  ...
  @override
  String toString() {
    return 'WeatherResponse(location: $location)';
  }
...
abstract class _WeatherResponse implements WeatherResponse {
  const factory _WeatherResponse({required final WeatherLocationDTO location}) =
